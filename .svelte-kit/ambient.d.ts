...
declare module '$env/static/private' {
	...
	export const NX_TUI_AUTO_EXIT: string;
	export const NX_VERBOSE_LOGGING: string;
	export const NX_PERF_LOGGING: string;
	export const NX_NATIVE_LOGGING: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		NX_DAEMON: string;
		NX_TUI: string;
		NX_TUI_AUTO_EXIT: string;
		NX_VERBOSE_LOGGING: string;
		NX_PERF_LOGGING: string;
		NX_NATIVE_LOGGING: string;
		SHELL: string;
		COLORTERM: string;
		NVM_INC: string;
